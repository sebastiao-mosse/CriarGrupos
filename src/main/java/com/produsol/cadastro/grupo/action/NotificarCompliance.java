...
public class NotificarCompliance  implements ActionHandler {
...
UserAuthenticationServices authentication = new UserAuthenticationServices();
	...
	{
		this.enviarEmailPersonalizado(authentication.getUserName(authentication.GetUsersByRole("ROLE_COMPLIANCE_OFFICER")));
	}
